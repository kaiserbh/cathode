...
pub fn SeriesDetail(
    ...
    rsx! {
        div {
            ...
            div {
                class: "flex max-h-[85vh] w-full max-w-2xl flex-col overflow-hidden rounded-xl \
                    bg-white text-neutral-900 shadow-xl dark:bg-neutral-900 dark:text-neutral-100",
                ...
                div {
                    ...
                    button {
                        class: "shrink-0 rounded-full p-1.5 text-neutral-500 hover:bg-neutral-100 \
                            ...
                            ul {
                                ...
                                for ep in season.episodes.iter().cloned() {
                                    li {
                                        ...
                                        button {
                                            class: "shrink-0 rounded-full bg-sky-600 p-1.5 text-white \
                                                hover:bg-sky-500",
                                            title: "Play",
