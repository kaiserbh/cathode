...
## [0.5.0](https://github.com/kaiserbh/cathode/compare/v0.5.3...v0.5.0) (2026-06-25)
...
* **aur:** added aur build and ci ([#22](https://github.com/kaiserbh/cathode/issues/22)) ([1184fc0](https://github.com/kaiserbh/cathode/commit/1184fc0d3c4e2ffeb6caa879076f8e2463198358))
* **brand:** add generated Android and iOS launcher icons ([4f50e14](https://github.com/kaiserbh/cathode/commit/4f50e14347f728868b18bf45c1766539bdff7cc2))
* **brand:** new Cathode app icon (glowing CRT with play) ([7ce357c](https://github.com/kaiserbh/cathode/commit/7ce357c000d1d758510a867fb1cc8fff27402162))
* **brand:** round the app icon into a macOS-style squircle ([67a9d63](https://github.com/kaiserbh/cathode/commit/67a9d63985f12faca38700738865f467a92ccfe7))
* **brand:** switch to the detailed retro-CRT app icon ([128d6b7](https://github.com/kaiserbh/cathode/commit/128d6b72a037df8f0e8248f62c7385865876a8d4))
...
* **browse:** hide content tabs a provider doesn't offer ([d2bb6b7](https://github.com/kaiserbh/cathode/commit/d2bb6b717a9ecd0bfbe0a912cba3a849b12b76f5))
...
* **catalog:** kind-keyed sqlite cache with ext and library search ([9d71c0c](https://github.com/kaiserbh/cathode/commit/9d71c0c1d14f6c3af0cc3b40b02e8b202e3acf30))
...
* **channels:** add a List view alongside the Grid ([dde07b2](https://github.com/kaiserbh/cathode/commit/dde07b2f488446ac21b57738bb411477bec845bb))
* **commands:** kind-aware listing, series info, search, and playback ([912c4da](https://github.com/kaiserbh/cathode/commit/912c4da2b0ebd81270527a9cd07efeb78c4581b6))
* **core:** add a structured LogLine record ([ae5402e](https://github.com/kaiserbh/cathode/commit/ae5402e50694fb631892814b7ab6ca04d08c6075))
* **core:** add container_extension and a series/episode model ([385f44d](https://github.com/kaiserbh/cathode/commit/385f44d36e50f13db368d58d82af133a1ab6f129))
* **core:** add credential redaction and a persisted log-level setting ([474e06c](https://github.com/kaiserbh/cathode/commit/474e06c468cf3d3165090f25ec88cda001eb5cd4))
...
* **core:** fetch/parse VOD and series, kind-keyed catalog, and search ([0ebb27e](https://github.com/kaiserbh/cathode/commit/0ebb27e23051dcfff409c81de827cab7320fa0bc))
...
* **epg:** add a timeline guide view mode ([1e7ecb5](https://github.com/kaiserbh/cathode/commit/1e7ecb57fc2d093a6a8f92dc3e651d412a389db7))
* **epg:** cache the full guide and serve name-aliased data ([4b3eb5b](https://github.com/kaiserbh/cathode/commit/4b3eb5b7d9e9579dc3a77cc54cbaece7c47988b1))
* **epg:** fetch and cache the guide, expose epg_now_next ([f1aa6e5](https://github.com/kaiserbh/cathode/commit/f1aa6e53d90ddbc6a4db29cf010cd740fdba236d))
* **epg:** match channels by name when they lack an epg_channel_id ([58cb650](https://github.com/kaiserbh/cathode/commit/58cb6500253a4718c59714f1dae70e7277003cd5))
* **epg:** parse channel display-names and add name matching ([6b873c7](https://github.com/kaiserbh/cathode/commit/6b873c76af241630d0ff30e333657b0a1e379cfe))
* **epg:** parse XMLTV and match programmes to now/next ([e232b8b](https://github.com/kaiserbh/cathode/commit/e232b8b4e917369780bb7a0620b13a98b408b9fc))
* **epg:** persist programmes in SQLite with descriptions ([eae3339](https://github.com/kaiserbh/cathode/commit/eae33391cf640410951219c94848ac3ea5cc35bd))
* **epg:** programme detail popover on cell click ([8362832](https://github.com/kaiserbh/cathode/commit/8362832373f82b04db68bb950386d719fe5ef2d3))
* **epg:** show now/next on channel cards ([8867740](https://github.com/kaiserbh/cathode/commit/8867740ecdf9b59559388f8764557cb26c352c06))
* **epg:** virtualize guide rows with dx virtual_list ([3b13199](https://github.com/kaiserbh/cathode/commit/3b1319932e88cd7ee845a9d3ce3356e0bdf0ac55))
...
* linux backend ([#19](https://github.com/kaiserbh/cathode/issues/19)) ([05fe1bc](https://github.com/kaiserbh/cathode/commit/05fe1bc9efe7d85ddf4b91e1bc141e34c317fe5a))
* **logs:** capture structured records scoped to Cathode's own crates ([d3eb601](https://github.com/kaiserbh/cathode/commit/d3eb6014b32c152e0d3f24c02dc2b2a348145982))
* **logs:** capture tracing into a ring buffer with a live level switch ([b7042b0](https://github.com/kaiserbh/cathode/commit/b7042b04bc14a5463e16ab1a60e0f17e89678a1e))
* **logs:** give the logs modal a min height ([1453b19](https://github.com/kaiserbh/cathode/commit/1453b192ca8e597a874df874d376498df891dbe0))
* **logs:** keep event fields separate from the message ([5c8cac3](https://github.com/kaiserbh/cathode/commit/5c8cac37b6cf597b14ca38b4edf5d641a4cd7f34))
* **logs:** log fetch, guide, and playback outcomes so the panel has content ([47a8c13](https://github.com/kaiserbh/cathode/commit/47a8c1363b5ef8d7f07ef24e55a0103faa8469ad))
* **logs:** make Trace capture everything and scope lower levels to Cathode ([3058f0b](https://github.com/kaiserbh/cathode/commit/3058f0b4703db3710ee8c5fb6c8b25f6ce42485a))
* **logs:** replace native select with primitives Select ([7c59f20](https://github.com/kaiserbh/cathode/commit/7c59f20d781810a93d30a99ebb1e88835d9c8df4))
...
* **playback:** render video on Windows via ANGLE ([e4e84b7](https://github.com/kaiserbh/cathode/commit/e4e84b782d161dbe369cd7ebd46ff13b78cfa7ef))
...
* **player:** backend volume, mute, and fullscreen controls ([96c7b9b](https://github.com/kaiserbh/cathode/commit/96c7b9bcb81d4476ad2bd3665dd106ba0c92d364))
* **player:** modern icon control bar with volume and QoL ([61cf90c](https://github.com/kaiserbh/cathode/commit/61cf90c894065f2370dcf0da2ca4f8afeb8d6050))
* **player:** show now/next in the player overlay ([3860268](https://github.com/kaiserbh/cathode/commit/3860268df54947f725664be404322c3e0575fba3))
* **player:** uniform volume slider via dioxus-primitives ([da8f535](https://github.com/kaiserbh/cathode/commit/da8f53545cec5ee61ec75f508a10ee6e970f185a))
* **player:** YouTube-style HUD for playback shortcuts ([96f22f4](https://github.com/kaiserbh/cathode/commit/96f22f479ef1baa7f0685a70f8cad165d9be91e6))
* **settings:** make EPG and channel view customisable ([cf16e12](https://github.com/kaiserbh/cathode/commit/cf16e124cb68464509d7955b3bb908676f802db1))
...
* **ui:** add a Logs panel with level dropdown, copy, and clear ([fbc9cdd](https://github.com/kaiserbh/cathode/commit/fbc9cddad527f4563612a1799c6f93169ff5cb2f))
* **ui:** add clipboard helper and log bindings ([ad35a5f](https://github.com/kaiserbh/cathode/commit/ad35a5f2bd12894a9d2a9cd09587cf6138353fa8))
* **ui:** add Dialog primitive and tune accent to sky ([ac23ad0](https://github.com/kaiserbh/cathode/commit/ac23ad07291a8ac4ff815e08f730dd9eaacead9a))
* **ui:** adopt Button for form and panel actions ([24f231f](https://github.com/kaiserbh/cathode/commit/24f231f495a630872db93cffe36b27f93cdc6741))
* **ui:** adopt Switch for the toggle control ([8710d45](https://github.com/kaiserbh/cathode/commit/8710d45dfe7bd6aa7313cee7d82a374dfa2c8563))
* **ui:** adopt Tabs for the browse tab bar ([614c39b](https://github.com/kaiserbh/cathode/commit/614c39b52760c1ff7ac1a207ab076dbee262dcf0))
* **ui:** adopt Toast provider/hook ([be67326](https://github.com/kaiserbh/cathode/commit/be673262404d8c37f504367f89a9b75ce17ba85d))
* **ui:** back the icon set with Lucide via dioxus-icons ([f55e967](https://github.com/kaiserbh/cathode/commit/f55e96781788cbfef62a1e2ea2635a86210439a1))
* **ui:** color log rows and add level + search filtering ([df34e0c](https://github.com/kaiserbh/cathode/commit/df34e0cb79bf00400bc7cb5b8a8003ffddca9447))
* **ui:** fold title and controls into a draggable titlebar with icon buttons ([f576afa](https://github.com/kaiserbh/cathode/commit/f576afad5fbcfb8b141e0fcd596f6633f6c808c8))
* **ui:** increase log panels min height. ([42edbb8](https://github.com/kaiserbh/cathode/commit/42edbb8419747d2eab43e0315fae0a984e03a367))
* **ui:** move modals onto the dioxus-primitives Dialog ([ee45fbe](https://github.com/kaiserbh/cathode/commit/ee45fbe05ad32785c05706b4768237bede4d83e5))
* **ui:** Movies/Series tabs, series drill-down, and library search ([8abbc83](https://github.com/kaiserbh/cathode/commit/8abbc831128518540c5955b02292ebfc573cfe3e))
* **ui:** open the Logs panel from a titlebar bug icon ([3ed20e0](https://github.com/kaiserbh/cathode/commit/3ed20e0348bc7b56e1944911914882653f45a50f))
* **ui:** render colored, aligned, auto-scrolling logs with icon actions ([c5f023f](https://github.com/kaiserbh/cathode/commit/c5f023fbaeb4de5bf419101ce63ce85982d40114))
* **ui:** show a toast when logs are copied ([2200511](https://github.com/kaiserbh/cathode/commit/2200511c2885e75a8d70926d96b5d29d28549d03))
* **ui:** title-bar tooltips + draggable top chrome ([5fdd74a](https://github.com/kaiserbh/cathode/commit/5fdd74ae5754a4e7a21665426310c73d7816e8b3))
* **ui:** use Lucide stars and history icon for favorites/tabs ([0a947a7](https://github.com/kaiserbh/cathode/commit/0a947a73f745c613488870c41f97bffe3dbac2ce))
* **ui:** vendor slider + select primitives ([64afb7c](https://github.com/kaiserbh/cathode/commit/64afb7c54927d63e61f97d16650f3449d3bc41ca))
* **ui:** vendor Switch/Tabs/Toast/Tooltip primitives ([e5dcce1](https://github.com/kaiserbh/cathode/commit/e5dcce1992ff7a492da83db54cbec8c2a0df2168))
* **window:** capitalize the app name and set default + minimum size ([a3cfff4](https://github.com/kaiserbh/cathode/commit/a3cfff471ef4daccaedfc1c073bdfe5e4ef9991c))


### Bug Fixes

* **brand:** give the app icon real transparency ([75de63b](https://github.com/kaiserbh/cathode/commit/75de63be9569dcaae44ddf3dcff55aae5a7ec704))
* **browse:** drop stale category responses and scroll panes independently ([2352944](https://github.com/kaiserbh/cathode/commit/23529442943090deaa955b47a6ca0bcf5ad54458))
* bundle libmpv runtime DLLs in the Windows installer ([ccb29a0](https://github.com/kaiserbh/cathode/commit/ccb29a09eb014f753e00b361035a471f8ed8d76e))
* dragging window ([fcdfba5](https://github.com/kaiserbh/cathode/commit/fcdfba5455fe10050bd7208ef88a93f4cb7d7573))
* **epg:** bound the virtualized guide height ([928f842](https://github.com/kaiserbh/cathode/commit/928f8428698de9a359f9141053d08edf695475b0))
* **epg:** make the programme popover title readable ([d6ccf7d](https://github.com/kaiserbh/cathode/commit/d6ccf7de4660a69ba4d6859f4ef25586da34273f))
* **http:** redact secrets in network errors and set a User-Agent ([251672b](https://github.com/kaiserbh/cathode/commit/251672b23b6727594565f566edb01543045d47c9))
* **logs:** reflect the chosen level in the dropdown ([47d9470](https://github.com/kaiserbh/cathode/commit/47d9470cc3ed8c94a166c88f63fe42ed825cf710))
* **playback:** volume control fix ([17de91d](https://github.com/kaiserbh/cathode/commit/17de91de5ede38df4a16890a42e6666d346e5aa3))
* **player:** constrain volume slider so it stops eating control clicks ([57f0589](https://github.com/kaiserbh/cathode/commit/57f0589b9fb7f89e60976042bc1d42c199ba2ce2))
* **player:** fill the volume slider track up to the thumb ([e760404](https://github.com/kaiserbh/cathode/commit/e760404586d5c065cf2ecc426f207f1c6c6904e7))
* **player:** recapture overlay focus after control use so shortcuts keep working ([63a8260](https://github.com/kaiserbh/cathode/commit/63a826029158c6738bcc0e775d9bad5ff441f1d0))
* **player:** replace dx Slider with a styled native range ([1b52147](https://github.com/kaiserbh/cathode/commit/1b52147bfa3ca6c0cba726e05abe739e044a488c))
...
* **player:** steady, more-transparent shortcut HUD ([260a8c8](https://github.com/kaiserbh/cathode/commit/260a8c8973e8c64ba573681964887f85331263fb))
* **ui:** keep dialogs off the screen edges and responsive ([0271e49](https://github.com/kaiserbh/cathode/commit/0271e497ceba180ecc7efb07c01e99453426a007))
* **ui:** keep the logs search input readable in dark mode ([6f8b7a1](https://github.com/kaiserbh/cathode/commit/6f8b7a1c5f48d51712ea0ad9c908b8b5be7fc410))
* **ui:** let panel width control dialog size ([6957d2f](https://github.com/kaiserbh/cathode/commit/6957d2f1161cb434a7e71b41b7b465c7a0f22ae4))
* **ui:** make search results readable in dark mode and center the empty state ([cdbf7e9](https://github.com/kaiserbh/cathode/commit/cdbf7e9ada9834eec9fea4176e558efdfa4b6605))
* **ui:** make titlebar draggable on macOS (spacer + startDragging fallback) ([3195011](https://github.com/kaiserbh/cathode/commit/3195011897a4b257943ff869daec4ec50cababcc))
* **ui:** stop modal focus trap from freezing the app ([6801f5f](https://github.com/kaiserbh/cathode/commit/6801f5f0c3bf7a105ae195b47f11c461c9ed2c42))
* **ui:** widen titlebar drag zone to w-28 (112 px) ([8817b71](https://github.com/kaiserbh/cathode/commit/8817b71440980d7f07fae9d3b236492dabdbbe27))


### Miscellaneous Chores

* set initial release to 0.5.0 ([72d2795](https://github.com/kaiserbh/cathode/commit/72d2795371d7c9eda11d18b9e4a9f3ab38881bef))
